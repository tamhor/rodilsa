		...
		$("#Customer_form").validate({
			...
			messages: {
				customer_name:{
					...
					accept: "Nama customer harus berisi huruf."
				},
				customer_contatc1: {
					required: "No telepon tidak boleh kosong.",
					maxlength: "No telepon harus berisi angka dan maximal 12",
				},
				customer_email: {
					required: "Nama email tidak boleh kosong",
				},
				customer_cnic:{
					required: "NIK/KTP tidak boleh kosong.",
					maxlength: "NIK/KTP harus berisi angka dan maksimal 15."
				},
				customer_address:{
