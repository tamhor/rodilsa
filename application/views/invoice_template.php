<div class="col-md-6 set-no-padding">
 <table class="table table-bordered black table-hover">
    <thead>
        <tr> 
            <th>Item</th>
           <!--  <th>Weight</th> -->
...
<div class="col-md-6">
        <div class="row total-grid-values">
            <div class="col-md-4 col-sm-12 col-xs-12">
                    Total Penjualan (<?php echo $currency; ?>) :
        ...
        <div class="row total-grid-values">
         ...
         <div class="row row-buttons text-center">
                <button  type="button" onclick="clear_invoice()" class="btn btn-primary btn-outline-primary btn-left-side-invoice"> 
                  <i class="fa fa-paper-plane" aria-hidden="true"></i> PENJUALAN BARU
                </button>                    
                ...
                <img src="<?php echo base_url();?>/uploads/users/ban.jpg" width="700px" />
         </div>
    </div>
</div>
