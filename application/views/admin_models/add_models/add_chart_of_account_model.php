			...
			<div class="box-body">	
				<div class="col-md-12">
					...
					<?php echo form_open($link,$attributes); ?>	
						...
						<?php echo form_label('Kode Akun:'); ?>
						<?php			
								$data = array('class'=>'form-control input-lg','type'=>'text','name'=>'id_head','placeholder'=>'Contoh 101, 102','reqiured'=>'');
					...
					<div class="form-group">
						...
						<?php			
								$data = array('class'=>'form-control input-lg','type'=>'text','name'=>'name','placeholder'=>'Masukan nama akun','reqiured'=>'');
								echo form_input($data);			
						?>
					</div>			
					<div class="form-group">
