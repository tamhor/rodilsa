					...
					<div class="row box box-default">
						...
						<div class="col-md-4">
							<div class="form-group">
								...
								<?php
								$data = array('class' => 'form-control input-lg ', 'type' => 'text', 'name' => 'customer_name', 'placeholder' => 'Masukkan Nama Customer');
						...
						<div class="col-md-4">
							<!-- <div class="form-group">
									...
									<?php
									$data = array('class' => 'form-control input-lg', 'type' => 'number', 'name' => 'customer_contact_two', 'placeholder' => 'e.g 00659855487');
									echo form_input($data);
									?>
								</div> -->
							<div class="form-group">
								...
								<?php
								$data = array('class' => 'form-control input-lg', 'type' => 'number', 'name' => 'customer_contatc1', 'placeholder' => 'e.g 00659855487');
								echo form_input($data);
								?>
							</div>
						</div>
						...
						<div class="col-md-4">
							<div class="form-group">
								...
								<?php
								$data = array('class' => 'form-control input-lg', 'type' => 'text', 'name' => 'customer_cnic', 'placeholder' => 'e.g 5248222154');
								echo form_input($data);
								?>
							</div>
						</div>
						...
						<div class="col-md-4">
							<div class="form-group">
								...
								<?php
								$data = array('class' => 'form-control input-lg', 'type' => 'text', 'name' => 'customer_address', 'placeholder' => 'e.g Jl. Apa Saja - 5566');
								echo form_input($data);
								?>
							</div>
						</div>
						...
						<!-- <div class="col-md-4">	
							   <div class="form-group">
							     <?php echo form_label('Perusahaan:'); ?>
								  <?php
									$data = array('class' => 'form-control input-lg', 'type' => 'text', 'name' => 'customer_company', 'placeholder' => 'e.g Pertamina');
									echo form_input($data);
									?>
				              </div>
			              </div> -->
						...
						<!-- <div class="col-md-4">	
							  <div class="form-group">
							     <?php echo form_label('Region:'); ?>
								  <?php
									$data = array('class' => 'form-control input-lg', 'type' => 'text', 'name' => 'customer_region', 'placeholder' => 'e.g Jawa Barat');
									echo form_input($data);
									?>
				              </div>
			              </div> -->
						...
						<div class="col-md-4">
							<div class="form-group">
								...
								<?php
								$data = array('class' => 'form-control input-lg', 'type' => 'text', 'name' => 'customer_town', 'placeholder' => 'e.g Karawang ');
								echo form_input($data);
								?>
							</div>
						</div>
