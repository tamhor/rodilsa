		   ...
		   <div class="form-group">
			<?php echo form_label('Username:'); ?>
	           <?php
					...
					$data = array('class'=>'form-control input-lg','type'=>'text','name'=>'user_email','placeholder'=>'Masukan Username','reqiured'=>'');
					echo form_input($data);
		   ...
		   <div class="form-group">
		    ...
		    <div class="form-group">
	           ...
	           <?php
					...
					$data = array('class'=>'form-control input-lg','type'=>'text','name'=>'User_description','placeholder'=>'Tambahkan deskripsi ','reqiured'=>'');
					echo form_input($data);
				?>
	      </div>
	      <div class="form-group">
