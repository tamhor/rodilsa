					...
					<?php echo form_open($link,$attributes); ?>  
			         <div class="form-group">    
						<?php
							...
							$data = array('class'=>'form-control input-lg','type'=>'text','name'=>'unit_name','placeholder'=>'e.g Bungkus, paket');
			         ...
			         <div class="form-group">    
						<?php
							...
							$data = array('class'=>'form-control input-lg','type'=>'text','name'=>'symbol','placeholder'=>'e.g Bks, pkt');
							echo form_input($data);							
						?>           
			         </div>	  
					 <div class="form-group">  				
