		...
		<?php echo form_open('product/add_barcode',$attributes); ?>  
		  ...
		  <div class="form-group">  				
			<?php
				...
				$data = array('class'=>'btn btn-info btn-outline-primary','type' => 'submit','name'=>'btn_submit_category','value'=>'true', 'content' => '<i class="fa fa-floppy-o" aria-hidden="true"></i> Simpan data');

				$data = array('class'=>'btn btn-info btn-outline-secondary','type' => 'submit','name'=>'btn_submit_category','value'=>'true', 'content' => '<i class="fa fa-floppy-o" aria-hidden="true"></i> Simpan data');
