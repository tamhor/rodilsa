    ...
    <div class="row">
        <div class="box box-primary">
           <div class="box-body">
            ...
            ?>
            <div class="col-md-12 col-sm-12 col-xs-12">
               <b>  Nama Customer : <?php echo $customer_arr[0]['customer_name'];  ?></b>
            </div>            
            <?php        
                }
             }
             ?>
            <div class="col-md-12 col-sm-12 col-xs-12">
                <b> No tagihan # <?php echo $invoice_data[0]->order_id; ?> </b>
            </div>
            <div class="col-md-12 col-sm-12 col-xs-12">
              <b>  Nama kasir : </b><?php echo $invoice_data[0]->agentname; ?>
            </div> 
            <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="number" readonly class="form-control no-border Edit_subtotal_amount " style="width:150px; float:right; "  value="<?php echo number_format($total,'2','.','');?>" name="" />Rp 
                                </td>
                            </tr>
                            <tr>
                                <th colspan="3">Diskon </th>
                                <td>
                                    <input type="number" name="edit_discount" id="discountfield" step=".01" class="form-control  edit_discount_box" value="0" style="width:150px; float:right; " />
                                Rp</td>
                            </tr>
                            <tr>
                                <th colspan="3">Total Pajak  </th>
                                <td><input type="number" style="width:150px; float:right; " readonly class="form-control no-border edit_tax_amount " value="<?php echo number_format($total_tax,'2','.',''); ?>" name="edit_tax_amount"/>Rp</td>
                            </tr>   
                            <tr>
                                <th colspan="3">Jumlah Total </th>
                                <td><input type="number" style="width:150px; float:right; " readonly class="form-control no-border Edit_total_amount " value="<?php echo number_format($total + $total_tax,'2','.',''); ?>" name="total_bill"/>Rp</td>
                            </tr>                           
                            <tr>
                                <th colspan="3">Jumlah Dibayar </th>  
                                <td><input type="number" step=".01" style="width:150px; float:right; " class="form-control amountpaid " value="<?php echo $invoice_data[0]->bill_paid; ?>" name="amountpaid"/>Rp</td>
                            </tr>
                            <tr>
                                <td colspan="3">Rincian</th>
                                 <td><input type="text" style="width:300px; float:right;" class="form-control edit_description input-lg" placeholder="masukan keterangan teks disini jika dibutuhkan" value="<?php echo $invoice_data[0]->description; ?>" name="edit_description"/>
                                </td>
                            </tr>
                              <tr>
                                <th colspan="10">Setting Lensa Kiri </th> 
                              </tr>      

                             <tr>
                                <td colspan="3">Sph Kiri</th>
                                 <td> <input type="text" class="form-control input-lg edit_sph"  value="<?php echo $invoice_data[0]->sph; ?>" name="edit_sph"/ type="option" style="width:80px; float:right;">
                            </tr>
                             <tr>
                                <td colspan="3">Cyln Kiri</th>
                                 <td><input type="text" style="width:80px; float:right;" class="form-control edit_cyln input-lg"  value="<?php echo $invoice_data[0]->cyln; ?>" name="edit_cyln"/>
                                </td>
                            </tr>
                             <tr>
                                <td colspan="3">xis kiri</th>
                                 <td><input type="text" style="width:80px; float:right;" class="form-control edit_xis input-lg"  value="<?php echo $invoice_data[0]->xis; ?>" name="edit_xis"/>
                                </td>
                            </tr>
