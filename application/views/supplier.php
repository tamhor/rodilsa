            ...
            <div class="box" id="print-section">
                ...
                <div class="box-body">
                    <div class="col-md-12 table-responsive">
                        <table id="example1" class="table table-bordered table-black">
                            <thead>
                                <tr>
                                    <?php
                                ...
                                <tr>
                                  ...
                                  <!--    <td>
                                   ...
                                   <!--  <td>
                                    ...
                                    <td>
                                        <?php echo img(array('width'=>'80','height'=>'80','class'=>'','src'=>'uploads/supplier/'.$single_supplier->cus_picture)); ?>
                                    </td>
                                    <td align="left">
                                    <?php 
                                    ...
                                    <td align="left">
                                        <div class="btn-group pull no-print pull-right">
                                            ...
                                            <ul class="dropdown-menu" role="menu">
                                                <li onclick="show_modal_page('<?php echo base_url().'supplier/popup/edit_supplier_model/'.$single_supplier->id; ?>')" ><a href="#"><i class="fa fa-pencil"></i> Edit</a></li>
                                                <li>
