...
<section class="content">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-1">
                            <div class="form-group margin" style="margin-top:25px;">
                                <?php
                                $data = array('class' => 'btn btn-info input-lg btn-outline-primary margin  pull-right', 'type' => 'submit', 'name' => 'searchecord', 'value' => 'true', 'content' => '<i class="fa fa-search" aria-hidden="true"></i> Cari');
                            ...
                            <tbody>
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <td>
                                                <?php echo format_rp($single_purchase->total_amount); ?>
                                            </td>
                                            <td>
                                                <?php echo format_rp($single_purchase->cash); ?>
                                            </td>
                                            <td>
                                                <?php echo format_rp($single_purchase->total_amount - $single_purchase->cash); ?>
                                            </td>
                                            <td>
    ...
    <div class="row bg-setting-product">
        <div class="col-md-12">
            <b>Total Tagihan Pembelian : </b> <?php echo format_rp($total_bill); ?>/-
            <b>Total Pembelian yg dibayar : </b> <?php echo format_rp($total_pur); ?>/-
            <b>Total Sisa : </b> <?php echo format_rp($total_bal); ?>/-
        </div>
    </div>
</section>
<!-- Bootstrap model  -->
