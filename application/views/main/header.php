                    ...
                    <div class="header-nav">
                        <ul class="nav navbar-nav pull-right">
		                  ...
		                  <?php echo $user_name['name']; ?>                               </a>
                            ...
                            </li>     <ul class="nav navbar-nav pull-right responsivetop">                           
                        <!--     <li class="con-tooltip bottom hidden-xs">
                           ...
                           <!--  </li>                            
                            ...
                            <li class="con-tooltip bottom hidden-sm">
                                <a  data-placement="bottom" href="https://www.tokopedia.com/optikrodilsa">
                             <img src="<?php echo base_url(); ?>uploads/users/tokopedia.png" width="33px" height="40px" >
                        </a>
                           <div class="tooltip ">
                                    <p>Tokopedia</p>
                                </div>
                              ...
                              <li class="con-tooltip bottom hidden-sm">
                                <a  data-placement="bottom" href="https://optik-rodilsa.business.site/">
                             <img src="<?php echo base_url(); ?>uploads/users/maps2.png" width="33px" height="40px" >
                        </a>
                           <div class="tooltip ">
                                    <p>Lokasi</p>
                                </div>
