<section class="content">
    <div class="box" id="print-section">
        <div class="box-header">
            <h3 class="box-title purchase-top-header"><i class="fa fa-hand-o-right" aria-hidden="true"></i> Transaksi Pembelian
            </h3>
            <div class="pull pull-right purchase-top-header">
                <a type="button" class="btn btn-danger btn-flat btn-sm" href="<?php echo base_url('purchase');?>" ><i class="fa fa-times" aria-hidden="true"></i> Tutup
                </a>
            </div>
        </div>
        <div class="box-body ">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <h4 class="purchase-heading"> Informasi Umum :</h4>       
                        <div class="col-md-3 ">
 ...
 -->
                            <div class="form-group">
                                <?php echo form_label('Nomor Tagihan'); ?>
                                <?php
                ...
                <div class="row">
                    <div class="col-md-12">
                        <h4 class="purchase-heading">  Informasi Pembelian :</h4>
                        <div class="col-md-3 ">
                            <div class="form-group">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <h4 class="purchase-heading">  Rincian Pembelian :</h4>         
                            <?php
