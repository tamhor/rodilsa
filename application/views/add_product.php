            ...
            <div class="box " id="print-section">
                ...
                <div class="box-body ">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>Upload Gambar Produk (bersifat optional):</label>
                ...
                <div class="box-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label> Warna: <a onclick="show_modal_page('<?php echo base_url(); ?>product/popup/add_brand_sector')" href="javascript:void(0)"> (Tambah Warna)</a></label>
                ...
                <div class="box-body bg-setting-product">
                    <h4 class="purchase-heading"><i class="fa fa-check-circle"></i> Jenis Unit: </h4>
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                 ...
                 <div class="col-md-3">
                    ...
                    <div class="box-body">
                        <h4 class="purchase-heading"><i class="fa fa-check-circle"></i> Stok </h4>
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                        ...
                        <div class="box-body bg-setting-product">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <?php echo form_label('Harga Jual / Pak:'); ?>
                                        <?php
