            ...
            <div class="box " >
                ...
                <div class="box-body bg-setting-product">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            <img class="img-rounded" width="200" height="200" src="<?php echo base_url('uploads/products/'.$product[0]->image)?>" />
                        </div>
                    </div>
                </div>
                <div class="box-body">
                    ...
                    <div class="row">
                         <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <?php               
                                $data = array('class'=>'form-control input-lg','type'=>'number','disabled'=>'disabled','name'=>'edit_total_units','value'=>$product[0]->total_units,'reqiured'=>'');
                                echo form_input($data);             
                                ?>
                            </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <?php               
                                $data = array('class'=>'form-control input-lg','type'=>'number','disabled'=>'disabled','name'=>'unit_per_pack','value'=>$product[0]->packsize,'reqiured'=>'');
                                echo form_input($data);             
                                ?>
                            </div>
                            <small>Total stok untuk produk tunggal ? </small>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                            <?php echo form_label('Harga Jual per Unit:'); ?>
                            <?php
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <?php echo form_label('Harga jual per Pak:'); ?>
                                <?php
                       ...
                       <!--  <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <?php echo form_label('Lokasi Unit: '); ?>
                                <?php
