...
<body class="hold-transition login-page " style="background-image:url('<?php echo base_url(); ?>uploads/systemimgs/bg-login.png'); background-size:cover; position: relative;">
   <br/><br/><br/><br/> <br/>
  <div class="col-md-4 col-md-offset-4" style=" background: red; padding:40px; border-radius:7px;">
  <br/><br/>   
        <h1 class="text-center">
            <a href="<?php echo base_url('login'); ?>"> <b style="color:white;">Optik Rodilsa</b></a>
        </h3>
        <div class="login-box-body">
            <p class="login-box-msg" style="color: #fffdfde0;font-size: 18px;">Silahkan masukkan Username dan Kata Sandi untuk melanjutkan</p>
            <?php
            ...
            <?php echo form_open('login/authentication',$attributes); ?>
                <div class="form-group has-feedback">
                    ...
                    <?php
                        $data = array('class'=>'form-control input-lg','id'=>'user_name','name'=>'user_name','value'=>'','placeholder'=>'Masukan Username','reqiured'=>'','AUTOCOMPLETE'=>'OFF');
                        echo form_input($data);
                    ?>  
                </div>
                <div class="form-group has-feedback">
                    <?php
                      $data = array('class'=>'form-control input-lg','id'=>'user_password','type'=>'password','name'=>'user_password','value'=>'','placeholder'=>'Masukan Kata Sandi','reqiured'=>'','AUTOCOMPLETE'=>'OFF');
                      echo form_input($data);
                    ?>
                </div>
                <div class="row">
