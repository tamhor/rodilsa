                            ...
                            <tbody>
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <td>
                                                <?php echo img(array('width' => '100', 'height' => '100', 'class' => '', 'src' => 'uploads/products/' . $obj_product_record_list->image)); ?>
                                            </td>
                                            <td align="left">
                                                <?php
                                            ...
                                            <td align="left">
                                                <?php echo format_rp($obj_product_record_list->purchase); ?>
                                            </td>
                                            <td align="left">
                                                <?php echo format_rp($obj_product_record_list->retail); ?>
                                            </td>
                                            <!--    <td>
