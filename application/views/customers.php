                            ...
                            <tbody>
                                ...
                                ?>
                                        ...
                                        <?php echo $obj_customer_list->cus_region; ?>
                                            ...
                                            <td>
                                                <?php echo img(array('width' => '80', 'height' => '80', 'class' => '', 'src' => 'uploads/customers/' . $obj_customer_list->cus_picture)); ?>
                                            </td>
                                            <td style="text-align: left;">
                                                <?php
                                            ...
                                            <td>
                                                <div class="btn-group pull no-print pull-right">
                                                    ...
                                                    <ul class="dropdown-menu" role="menu">
                                                        ...
                                                        <li onclick="show_modal_page('<?php echo base_url() . 'customers/popup/edit_customer_model/' . $obj_customer_list->id; ?>')"><a href="#"><i class="fa fa-pencil"></i> Edit</a></li>
                                                        <li>
