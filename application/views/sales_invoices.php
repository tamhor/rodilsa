<div class="row">
    <div class="col-md-12 ">
        ...
        <div class="col-md-3">
            <div class="form-group margin ">
                <?php echo form_label('Masukan No Penjualan:'); ?>
                <?php
...
?>
    <section class="invoice" id="<?php echo $Sales_Record[$i][0]->id; ?>">
        ...
        <img src="<?php echo base_url(); ?>/uploads/users/logo.png" width="300px" height="70px" />
        <div class="row">
 ...
 -->
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <b> Jl. Nusantara Raya Blok A 4/24 Perumnas 3 Bekasi Timur </b>

                </div>
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <b> Telp : 021 - 8834 5425 - 0815 1905 2041 </b>
                ...
                ?>
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <b> Nama Customer : </b> <?php echo $customer_arr[0]['customer_name'];  ?>
                        </div>
                <?php
                    }
                }
            ...
            <div class="col-md-3 col-sm-3 col-xs-12  ">
                <div class="col-md-12 col-sm-12 col-xs-12 ">
                    <b> Nama Kasir : </b><?php echo $invoices_Record[$i]->agentname; ?>
                </div>
                <?php
 ...
 -->
                                <td>
                                    <?php echo format_rp($Sales_Record[$i][$counter]->price); ?>
                                </td>
                                <td>
                ...
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <tr style="border-bottom: 2px dotted #eee;">
                            ...
                            <td class="text-center">
                                <?php echo format_rp($invoices_Record[$i]->discount); ?>
                            </td>
                        </tr>
                        <?php
                        ...
                        <tr style="border-bottom: 2px dotted #eee;">
                            ...
                            <td class="text-center">
                                <?php echo format_rp($total_after_dis); ?>
                            </td>
                        </tr>
                        <tr style="border-bottom: 2px dotted #eee;">
                        ...
                        <tr style="border-bottom: 2px dotted #eee;">
                            <th>Total (
                                <?php echo $currency; ?>):</th>
                            <td class="text-center">
                                <?php echo format_rp($new_amount); ?>
                            </td>
                        </tr>
                        <?php
                        if ($invoices_Record[$i]->status == 1 or $invoices_Record[$i]->source == 1) {
                        ?>
                            <tr align="center" style="border-bottom: 2px dotted #eee;">
                                <td colspan=7>
                            ...
                            <tr align="center" style="border-bottom: 2px dotted #eee;">
                                <td colspan=7>
                                    <img src="<?php echo base_url(); ?>/uploads/users/grafik.jpg" width="600px" height="230px" />
                                </td>
                            </tr>

                            <tr align="left" style="border-bottom: 2px dotted #eee;">
                                <td colspan=7>
                                    <b>Sph : </b> <?php echo $invoices_Record[$i]->sph; ?>
                                </td>
                            </tr>
                            <tr align="left" style="border-bottom: 2px dotted #eee;">
                                <td colspan=7>
                                    <b>Cyln : </b> <?php echo $invoices_Record[$i]->cyln; ?>
                                </td>
                            </tr>
                            <tr align="left" style="border-bottom: 2px dotted #eee;">
                                <td colspan=7>
                                    <b>xis : </b> <?php echo $invoices_Record[$i]->xis; ?>
                                </td>
                            </tr>
                        <?php
                        }
                        ...
                        <tr style="border-bottom: 2px dotted #eee;">
                            <td colspan="7">[
                                ...
                                <b> Jumlah Diterima:</b> <?php echo format_rp($invoices_Record[$i]->bill_paid); ?> /- ] [ <b> Sisa:</b> <?php echo format_rp($invoices_Record[$i]->total_bill - $invoices_Record[$i]->bill_paid); ?> /- ]
                            </td>
                        </tr>
                        <tr align="center" style="border-bottom: 2px dotted #eee;">
                            <td colspan=7>
                                <b> terimakasih Telah berbelanja di Optik Rodilsa </b>
                            </td>
                        </tr>
                        </tr>
                        <tr align="left" style="border-bottom: 2px dotted #eee;">
                            <td colspan=7>
                                <b> Keterangan : Barang yang sudah dibeli tidak dapat ditukar atau dikembalikan </b>
                            </td>
                        </tr>
                    </table>
                </div>
