...
function random_number() 
{
 ...
 public function edit()
 {
  ...
  {  
    ...
    {
     $array_msg = array(
      'msg' => '<i style="color:#fff" class="fa fa-pencil-square-o" aria-hidden="true"></i> Data Produk Berhasil Diedit',
      'alert' => 'info'
     );
     $this->session->set_flashdata('status', $array_msg);
    }
    ...
    {
     $array_msg = array(
      'msg' => '<i style="color:#c00" class="fa fa-exclamation-triangle" aria-hidden="true"></i> Data Product Tidak Berhasil Diedit',
      'alert' => 'danger'
     );
     $this->session->set_flashdata('status', $array_msg);
    }  
