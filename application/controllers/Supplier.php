...
class Supplier extends CI_Controller
{
 ...
 function upload_csv()
	...
	function edit_supplier_payments()
	{
		...
		{
			$array_msg = array(
				'msg' => '<i style="color:#fff" class="fa fa-pencil-square-o" aria-hidden="true"/> Data Pembayaran Supplier Berhasil Diedit',
				'alert' => 'info'
			);
			$this->session->set_flashdata('status', $array_msg);
		}
		...
		{
			$array_msg = array(
				'msg' => '<i style="color:#c00" class="fa fa-exclamation-triangle" aria-hidden="true"/> Data Pembayaran Supplier Tidak Berhasil Diedit',
				'alert' => 'danger'
			);
			$this->session->set_flashdata('status', $array_msg);
		}
	...
	public function add_supplier()
	{
			...
			if ($email_record_data == NULL)
			{
				...
				{
					$array_msg = array(
						'msg' => '<i style="color:#fff" class="fa fa-check-circle-o" aria-hidden="true"></i> Data Supplier Berhasil Ditambahkan',
						'alert' => 'info'
					);
					$this->session->set_flashdata('status', $array_msg);
				}
				...
				{
					$array_msg = array(
						'msg' => '<i style="color:#c00" class="fa fa-exclamation-triangle" aria-hidden="true"></i> Data Supplier Tidak Berhasil Ditambahkan',
						'alert' => 'danger'
					);
					$this->session->set_flashdata('status', $array_msg);
				}
	...
	public function delete($args)
	{
		...
		{
			$array_msg = array(
				'msg' => '<i style="color:#fff" class="fa fa-trash-o" aria-hidden="true"/> Data Supplier Berhasil Dihapus',
				'alert' => 'info'
			);
			$this->session->set_flashdata('status', $array_msg);
		}
		...
		{
			$array_msg = array(
				'msg' => '<i style="color:#c00" class="fa fa-exclamation-triangle" aria-hidden="true"/> Data Supplier tidak Berhasil Dihapus',
				'alert' => 'danger'
			);
			$this->session->set_flashdata('status', $array_msg);
		}
	...
	public function edit()
	{
		// DEFINES LOAD CRUDS_MODEL FORM MODELS FOLDERS
			...
			{
				$array_msg = array(
					'msg' => '<i style="color:#fff" class="fa fa-pencil-square-o" aria-hidden="true"></i> Data Supplier Berhasil Diedit',
					'alert' => 'info'
				);
				$this->session->set_flashdata('status', $array_msg);
			}
			...
			{
				$array_msg = array(
					'msg' => '<i style="color:#c00" class="fa fa-exclamation-triangle" aria-hidden="true"></i> Data Supplier Tidak Berhasil Diedit',
					'alert' => 'danger'
				);
				$this->session->set_flashdata('status', $array_msg);
			}
