...
class Users extends CI_Controller
{
	...
	public function add_user()
	{
		...
		if ($email_record_data == NULL)
		{
			...
			{
				$array_msg = array(
					'msg' => '<i style="color:#fff" class="fa fa-check-circle-o" aria-hidden="true"/> User berhasil ditambahkan',
					'alert' => 'info'
				);
		...
		{
			$array_msg = array(
				'msg' => '<i style="color:#c00" class="fa fa-exclamation-triangle" aria-hidden="true"></i>Maaf nama email sudah ada !',
				'alert' => 'danger'
			);
			$this->session->set_flashdata('status', $array_msg);
		}
