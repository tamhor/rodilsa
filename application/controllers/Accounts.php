...
class Accounts extends CI_Controller
{
     ...
     public function chart_of_account()
     {
      ...
      $id_head = html_escape($this->input->post('id_head'));
     ...
     // $relation = html_escape($this->input->post('relation'));
      ...
      if ($result == NULL)
      {
          ...
          {
            $array_msg = array(
             'msg' => '<i style="color:#fff" class="fa fa-check-circle-o" aria-hidden="true"></i> Data Akun Berhasil Ditambahkan',
             'alert' => 'info'
            );
     ...
     function delete($args)
     {
      ...
      {
       $array_msg = array(
        'msg' => '<i style="color:#fff" class="fa fa-trash-o" aria-hidden="true"></i> Data Akun Berhasil Dihapus',
        'alert' => 'info'
       );
       $this->session->set_flashdata('status', $array_msg);
      }
      ...
      {
       $array_msg = array(
        'msg' => '<i style="color:#c00" class="fa fa-exclamation-triangle" aria-hidden="true"></i> Data Akun Tidak Dapat Dihapus',
        'alert' => 'danger'
       );
       $this->session->set_flashdata('status', $array_msg);
      }
     ...
     function edit_charts()
     {
      ...
      {
       $array_msg = array(
        'msg' => '<i style="color:#fff" class="fa fa-pencil-square-o" aria-hidden="true"></i> Data Akun Berhasil Diubah',
        'alert' => 'info'
       );
       $this->session->set_flashdata('status', $array_msg);
      }
     ...
     function add_customer_payments()
     {
      ...
      $args = array(
       ...
       {
        $array_msg = array(
         'msg' => '<i style="color:#fff" class="fa fa-check-circle-o" aria-hidden="true"/> Data Pembayaran Customer Berhasil ditambahkan',
         'alert' => 'info'
        );
        $this->session->set_flashdata('status', $array_msg);
       }
