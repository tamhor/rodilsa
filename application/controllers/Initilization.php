...
class Initilization extends CI_Controller
{
  ...
  function __construct() 
  {
   ...
   function add_brand()
   {
      ...
      {
        $array_msg = array(
          'msg' => '<i style="color:#fff" class="fa fa-check-circle-o" aria-hidden="true"></i> Data merek berhasil ditambahkan',
          'alert' => 'info'
        );
   ...
   function edit_brand()
   {
      // DEFINES READ CATEROTY NAME FORM CATEGORY FORM
        ...
        {
          $array_msg = array(
            'msg' => '<i style="color:#fff" class="fa fa-check-circle-o" aria-hidden="true"></i> Data Merek Berhasil Diubah',
            'alert' => 'info'
          );
          $this->session->set_flashdata('status', $array_msg);
        }
   ...
   public function brandSector()
   {
    ...
    // DEFINES PAGE TITLE
    $data['title'] = 'Sektor Merk';

    // DEFINES NAME OF TABLE HEADING
    $data['table_name'] = 'SEKTOR MERK :';
   ...
   function add_brand_sector()
   {
      ...
      {
        $array_msg = array(
          'msg' => '<i style="color:#fff" class="fa fa-check-circle-o" aria-hidden="true"></i> Data Merek berhasil di tambahkan',
          'alert' => 'info'
        );
        $this->session->set_flashdata('status', $array_msg);
      }
   ...
   public function region()
   {
    ...
    // DEFINES PAGE TITLE
    $data['title'] = 'Daftar Region';

    // DEFINES NAME OF TABLE HEADING
    $data['table_name'] = 'DAFTAR REGION :';
  ...
  //Initilization/add_town
   ...
   function add_unit()
   {
      ...
      {
        $array_msg = array(
          'msg' => '<i style="color:#fff" class="fa fa-check-circle-o" aria-hidden="true"></i> Data Unit Berhasil Ditambahkan',
          'alert' => 'info'
        );
        $this->session->set_flashdata('status', $array_msg);
      }
      ...
      {
        $array_msg = array(
          'msg' => '<i style="color:#c00" class="fa fa-exclamation-triangle" aria-hidden="true"></i> Data unit Tidak Berhasil Ditambahkan',
          'alert' => 'danger'
        );
        $this->session->set_flashdata('status', $array_msg);
      }
   ...
   function edit_unit()
   {
      ...
      {
        $array_msg = array(
          'msg' => '<i style="color:#fff" class="fa fa-check-circle-o" aria-hidden="true"></i> Data Unit Berhasil Diubah',
          'alert' => 'info'
        );
        $this->session->set_flashdata('status', $array_msg);
      }
      ...
      {
        $array_msg = array(
          'msg' => '<i style="color:#c00" class="fa fa-exclamation-triangle" aria-hidden="true"></i> Data Unit Tidak Berhasil Diubah',
          'alert' => 'danger'
        );
        $this->session->set_flashdata('status', $array_msg);
      }
  ...
  //USED TO EDIT STORE 
   ...
   function delete($table, $args)
   {
    ...
    {
     $array_msg = array(
      'msg' => '<i style="color:#fff" class="fa fa-trash-o" aria-hidden="true"></i> Data Merek Berhasil Dihapus',
      'alert' => 'info'
     );
